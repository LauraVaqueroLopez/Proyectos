  ...
  <main class="container my-4">
    <div class="row">
      ...
      <section class="col-md-8 principal-container">
        <h3>Quiénes Somos</h3>
        <p>
          Elegimos un estilo corporativo en verde y negro para transmitir confianza y profesionalismo,
          valores esenciales de nuestra empresa. Estamos disponibles para realizar cualquier servicio
          de nuestra página web. Contáctanos.
        </p>
      </section>
    </div>
  </main>
